...
--
-- Máquina: localhost
-- Data de Criação: 06-Out-2014 às 23:30
...
CREATE TABLE IF NOT EXISTS `anuncio` (
  `cdanuncio` bigint(20) NOT NULL AUTO_INCREMENT,
  ...
  `imagemUrl` varchar(250) DEFAULT NULL,
...
INSERT INTO `anuncio` (`cdanuncio`, `cdcategoria`, `cdcidade`, `cdestado`, `cdpais`, `cdpasta`, `titulo`, `descricao`, `valor`, `nomecontato`, `email`, `telefone`, `imagemUrl`, `hashcode`, `dtanuncio`) VALUES
(1, 1, 4500, 24, 1, 0, 'Vendo computador', 'Estou vendendo um computador usado', 100, 'Bob', 'bob@gmail.com', '48 99959277', 'TODO', 'TODO', '0000-00-00'),
(4, 1, 79, 1, 1, 1, 'Teste', 'teste de descricao', 100, 'bob', 'bob@gmail.com', '0099888777', 'TODO', 'TODO2', '0000-00-00'),
(5, 1, 3198, 16, 1, 1, 'Teste', 'teste de vendas', 100, 'bob', 'bob@teste.com', '99887766', 'TODO', 'c8744b79ee59c121126ca3bd180d256e1357a7d3', '0000-00-00'),
(6, 4, 5250, 26, 1, 1, 'Vende uma bola', 'Estou vendendo uma bola de couro oficial da fifa.', 50, 'Fulano', 'fulano@gmail.com', '48 9978-3322', 'TODO', '33d73450e2c259a0ffa430f6090f425484869780', '0000-00-00'),
(7, 8, 4660, 24, 1, 1, 'Vende-se cachorros', 'Estou vendendo cachorros da raÃ§a pincher', 500, 'Roberto da ConceÃ§Ã£o', 'conceicao.roberto@gmail.com', '48 99959277', 'TODO', '7b4e97a6dbd86d5777a6af37245f7a9c838574ea', '0000-00-00');

-- --------------------------------------------------------

--
-- Estrutura da tabela `anunciofoto`
--

CREATE TABLE IF NOT EXISTS `anunciofoto` (
  `cdfoto` bigint(20) unsigned NOT NULL AUTO_INCREMENT,
  `cdanuncio` bigint(20) unsigned NOT NULL,
  `url` varchar(250) NOT NULL,
  PRIMARY KEY (`cdfoto`)
) ENGINE=InnoDB  DEFAULT CHARSET=latin1 AUTO_INCREMENT=7 ;

--
-- Extraindo dados da tabela `anunciofoto`
--

INSERT INTO `anunciofoto` (`cdfoto`, `cdanuncio`, `url`) VALUES
(1, 1, 'd676939b4189eebe781a1f60dfcdd17f.jpg'),
(2, 1, 'd545cfbbae8eebaacef6063e192b6a95.gif'),
(3, 1, 'f0b00b316c6059a6b86d9dc07c18797b.jpg'),
(4, 1, '85925eb27062b88a846ebf8fd6e5746d.jpg'),
(5, 1, '0d163970bc69463cce05c864f4f7b0e4.jpg'),
(6, 1, '503d6edd95e8292c32086dec9dc8c653.JPG');
...
CREATE TABLE IF NOT EXISTS `foto` (
  `nmfoto` varchar(250) NOT NULL,
  `cdanuncio` bigint(20) unsigned NOT NULL,
  UNIQUE KEY `nmfoto` (`nmfoto`)
...
INSERT INTO `foto` (`nmfoto`, `cdanuncio`) VALUES
('1ad37b40699f3f37f2390ef472e27851.jpg', 1),
('1fc91142d2c010a59f6ee6981ddd8566.jpg', 1),
('24c6a2569ec157ae0751f4fc18d6c564.png', 1),
('c20f37c7991f49007a7a187516fb1225.jpg', 1),
('c4f2aebf362833e16d1957f8ac361c6c.jpg', 1);
...
INSERT INTO `pasta` (`id`, `cdpasta`) VALUES
(1, 16);
...
--
ALTER TABLE `anuncio`
  ADD CONSTRAINT `anuncio_ibfk_1` FOREIGN KEY (`cdcategoria`) REFERENCES `categoria` (`cdcategoria`),
  ADD CONSTRAINT `anuncio_ibfk_2` FOREIGN KEY (`cdcidade`) REFERENCES `cidade` (`id`),
  ADD CONSTRAINT `anuncio_ibfk_3` FOREIGN KEY (`cdestado`) REFERENCES `estado` (`id`),
  ADD CONSTRAINT `anuncio_ibfk_4` FOREIGN KEY (`cdpais`) REFERENCES `pais` (`id`);
