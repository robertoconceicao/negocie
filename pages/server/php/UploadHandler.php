...
class UploadHandler
{
    ...
    function __construct($options = null, $initialize = true, $error_messages = null) {
		$cdpasta = isset($_REQUEST['cdpasta']) ? $_REQUEST['cdpasta'] : null;
		if($cdpasta === null){
			$cdpasta = isset($_GET['cdpasta']) ? $_GET['cdpasta'] : null;	
		}		
		
        $this->options = array(
            'script_url' => $this->get_full_url().'/',
            'upload_dir' => dirname($this->get_server_var('SCRIPT_FILENAME')).'/files/'.$cdpasta.'/',
            'upload_url' => $this->get_full_url().'/files/'.$cdpasta.'/',
            'user_dirs' => false,
            'mkdir_mode' => 0755,
            'param_name' => 'files',
